  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
       ...
       <li><a href="index.php?page=Managers"><span class="glyphicon glyphicon-envelope"></span>Managers</a></li>
       
       <li><a href="index.php?page=Sent_Queries"><span class="glyphicon glyphicon-envelope"></span>Sent Queries</a></li>
            <li><a href="index.php?page=chart"><span class="glyphicon glyphicon-envelope"></span>Chart With Friends</a></li>
          </ul>
