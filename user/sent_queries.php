...
if(isset($add))
{
	...
	else
	{
		foreach($user as $v)
		{
mysqli_query($conn,"insert into notice values('','$v','{$_SESSION['user']}','$sub','$details',now())");
		}
...
?>
<center><h2 style="color: blue">Sent Queries to Manager</h2></center>
<form method="post">
	...
	<div class="row">
		<div class="col-sm-4">Select Recipients</div>
		<div class="col-sm-5">
